...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b557fd11-bd72-400c-85b7-0f161fc3a1e4
```

> `b557fd11-bd72-400c-85b7-0f161fc3a1e4` is the password of the certificate, you can change it to any password you want.
